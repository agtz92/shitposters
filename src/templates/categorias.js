  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="10datos.com categorias promoción, entretenimiento y propagación de información de último minuto"
        />
      ...
      <LayoutContainer>
        <div>
          ...
          <div style={{ padding: "10px" }} className="parpost light">
            10datos.com es una página informativa que recopila información de
            muchas fuentes de información. No poseemos los derechos de ninguna
            imagen ni contenido presentada en el sitio web.
          </div>
          <Link to="/categorias">
