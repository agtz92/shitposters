    ...
    <>
      <Layout>
        <Helmet>
          ...
          <meta
            name="description"
            content="Ve nuestra política de privacidad"
          />
        </Helmet>
        <div
          style={{
        ...
        >
          <Heading color="dark" alignment="left">
            Política de privacidad
          </Heading>
          <p>
            El presente Política de Privacidad establece los términos en que
            10datos.com usa y protege la información que es proporcionada por
          ...
          <p>
            10datos.com está altamente comprometido para cumplir con el
          ...
          <p>
            10datos.com Se reserva el derecho de cambiar los términos de la
